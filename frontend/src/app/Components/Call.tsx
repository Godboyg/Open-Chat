...
function Call({
  ...
  const [small, setSmall] = useState(false);
    ...
    console.log("remote",remote , remoteVideo);
  ...
  return (
    <div className="fixed inset-0 bg-black backdrop-blur-sm text-white overflow-hidden">
        ...
        <video
          ...
          className={`
            ...
            ${
              shink
                ? small
                  ? "fixed top-2 left-1/2 -translate-x-1/2 w-20 h-14 z-[999]"
                  : "fixed top-2 left-1/2 -translate-x-1/2 w-40 h-24 z-[999]"
                : "w-full h-full"
            }
          `}
        />
      ...
      {shink && (
        <div
          className="absolute top-0 left-0 w-full z-20 bg-black/50 backdrop-blur-sm p-2 flex items-center justify-between"
        >
          <div
      ...
      {callState === "connected" && (
        <div className="absolute bottom-5 left-1/2 -translate-x-1/2 z-30
          ...
          <button
            className="border border-red-500 px-4 py-1 rounded-xl"
            onClick={onEndCall}
          >
            🔴 End
          </button>
